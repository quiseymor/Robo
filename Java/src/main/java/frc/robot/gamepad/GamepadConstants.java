...
public class GamepadConstants
{
    ...
    public static final int SQUARE_BUTTON       = 1; // 4
    public static final int CIRCLE_BUTTON       = 3;
    public static final int TRIANGLE_BUTTON     = 4; // 6
    public static final int LEFT_BUMPER         = 5;
    public static final int RIGHT_BUMPER        = 6;
    public static final int LEFT_TRIGGER        = 9; // 7
    public static final int RIGHT_TRIGGER       = 10; // 10 8
    public static final int SHARE_BUTTON        = 9;
    public static final int OPTIONS_BUTTON      = 10; // 10
    ...
    //DPAD
    public static final int DPAD_X              = 4; // 4
    public static final int DPAD_Y              = 5; // 5
}